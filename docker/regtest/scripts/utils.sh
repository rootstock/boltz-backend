...
function startLnds () {
  ...
  # Start the LNDs
  nohup lnd --lnddir=/root/.lnd-btc --listen=0.0.0.0:9735 --profile=9737 --rpclisten=0.0.0.0:10009 --restlisten=0.0.0.0:8080 --bitcoin.active --bitcoin.regtest --bitcoin.node=bitcoind --bitcoind.rpchost=127.0.0.1:18443 --routing.assumechanvalid > /dev/null 2>&1 & num="0"
  nohup lnd --lnddir=/root/.lnd-btc2 --listen=127.0.0.1:9736 --profile=9738 --rpclisten=0.0.0.0:10011 --restlisten=0.0.0.0:8081 --bitcoin.active --bitcoin.regtest --bitcoin.node=bitcoind --bitcoind.rpchost=127.0.0.1:18443 --routing.assumechanvalid > /dev/null 2>&1 & num="0"

  nohup lnd --lnddir=/root/.lnd-ltc --listen=0.0.0.0:10735 --rpclisten=0.0.0.0:11009 --restlisten=0.0.0.0:9080 --litecoin.active --litecoin.regtest --litecoin.node=litecoind --litecoind.rpchost=127.0.0.1:19443 > /dev/null 2>&1  & num="0"
